      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h1 className="text-black text-3xl title-font font-medium mb-4">History</h1>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mt-6 lg:mt-0">
            <h1 className="text-black  text-3xl title-font font-medium mb-4">Vision</h1>
            <p className="leading-relaxed mb-4">
              Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY.
            </p>
...
//   <div className="container px-5 py-24 mx-auto flex flex-wrap">
//     <div className="lg:w-1/2 w-full mb-10 lg:mb-0">
//     <img className="rounded-full w-32 h-32 object-cover object-center" src= {p1} alt="person"> </img>
//       {/* <img alt="ecommerce" className="object-cover object-center rounded-lg" src="https://dummyimage.com/800x600"> */}
//     </div>
//     <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
//       <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">History</h1>
//       <p className="leading-relaxed mb-4">
//         Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY.
//       </p>
//       <div className="relative pl-8 sm:pl-32 py-6 group">
...
//   <div className="container px-5 py-24 mx-auto flex flex-wrap">
//     <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mt-6 lg:mt-0">
//       <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Vision</h1>
//       <p className="leading-relaxed mb-4">
//         Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY.
//       </p>
//       <div className="relative pl-8 sm:pl-20 py-6 group">
...
//     </div>
//     <div className="lg:w-1/2 w-full mb-10 lg:mb-0">
//     <img className="rounded-full w-32 h-32 object-cover object-center" src={p2} alt="person"> </img>
//       {/* <img alt="ecommerce" className="object-cover object-center rounded-lg" src="https://dummyimage.com/800x600"> */}
//     </div>
//   </div>
// </section>
