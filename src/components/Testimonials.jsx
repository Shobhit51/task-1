...
const Testimonials = () => import React, { useState } from 'react';
import p3 from '../images/p3.png' ;
 ...
 const testimonials = [
    {
      ...
      name: 'Kevin Whatson',
      testimonial: 'lorem sit amet consectetur adipisicing elit. Voluptafacilis totam molliAb veniam maiores quasi ',
      image: p3, 
    },
    {
      id: 2,
    ...
    },
    {
      ...
      category: 'CEO Kingsten',
      name: 'Kevin Whatson',
      testimonial: ' Voluptafacilis totam molliAb veniam maiores quasi ',
    ...
    },
    {
      ...
      category: 'CEO Kingsten',
      name: 'Kevin Whatson',
      testimonial: 'l. Voluptafacilis totam molliAb veniam maiores quasi ',
      ...
      <h1 className="text-center text-black text-4xl  font-serif font-medium mb-14">What Our Clients Say</h1>
        ...
        <div className="flex flex-wrap -m-4">
          {testimonials.slice(currentSlide * testimonialsPerSlide, (currentSlide + 1) * testimonialsPerSlide).map((testimonial) => (
            <div key={testimonial.id} className={`p-4 md:w-1/${testimonialsPerSlide} transition-opacity duration-500`}>
  ...
  <p className="leading-relaxed mb-3 text-white">{testimonial.testimonial}</p>
        ...
        {/* Slider with three dots pagination */}
